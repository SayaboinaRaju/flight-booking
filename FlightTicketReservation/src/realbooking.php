...
function send_mail(){
  ...
  $result=mysqli_query($db,"SELECT F.Flight_name,F.Seats,T.Departure,T.Arrival,cp.Price,cl.Cname,C.Departure_time,C.Arrival_time,D.Day,U.Pname,U.paid_by
    ...
    $passengerEmail = mysqli_query($db, "SELECT eid FROM users where uname=".$_SESSION['uname']);
    echo $passengerEmail;
    ...
    $headers .= 'From: sayaboinarajuyadav8642@gmail.com' . "\r\n";
    mail($passengerEmail, "Ticket confirmatiom", $bodymsg, $headers);
    }
}
